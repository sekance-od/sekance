          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a href="https://tr.wikipedia.org/wiki/Anasayfa" className="hover:underline">
                    Wikipedia
                  </a>
                </li>
                <li>
                  <a href="https://www.bbc.com/" className="hover:underline">
                    BBC
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a href="https://web.telegram.org/k/" className="hover:underline ">
                    Telegram
                  </a>
                </li>
                <li className="mb-4">
                ...
                <li>
                  <a href="https://twitter.com/?lang=tr" className="hover:underline">
                    Twitter
                  </a>
                </li>
              </ul>
