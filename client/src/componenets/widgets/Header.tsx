...
const Header = () => {
  return (
    <div className="flex flex-row justify-between w-full bg-slate-800 py-5 px-10  items-center">
      ...
      <div className="flex">
        <p className="text-white font-medium hover:font-bold  mx-2">
          <Link to="/homeview">Home</Link>
        </p>
        <p className="text-white font-medium hover:font-bold mx-2">
          <Link to="/marketview">Piyasalar</Link>
        </p>
        <p className="text-white font-medium hover:font-bold mx-2">
          <Link to="/profilepageview">Profile</Link>
        </p>
        <p className="text-white font-medium hover:font-bold mx-2">
          <Link to="/walletview">Cüzdan</Link>
        </p>
      </div>
      <div className="flex h-full items-center justify-center rounded-full">
        <button className="rounded-full bg-gray-400 w-[40px] h-[40px] flex  items-center justify-center">
          <HiOutlineSun size={25} />
        </button>
        <button className="flex bg-gray-500 w-[150px] h-full p-5 justify-center mx-5 rounded-md">
